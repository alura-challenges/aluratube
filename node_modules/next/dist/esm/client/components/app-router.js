 ...
 */ function Router({ initialHead , initialTree , initialCanonicalUrl , children , assetPrefix  }) {
    const initialState = useMemo(()=>{
        return {
            ...
            typeof window !== 'undefined' ? createHrefFromUrl(new URL(window.location.href)) : initialCanonicalUrl
        };
    }, [
        children,
        initialCanonicalUrl,
   ...
   */ const onPopState = useCallback(({ state  })=>{
    ...
    }, initialHead, cache.subTreeData) : /*#__PURE__*/ React.createElement(React.Fragment, null, initialHead, cache.subTreeData))))));
}
